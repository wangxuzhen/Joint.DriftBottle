...
$.fn.progressbar.defaults={width:"auto",height:32,value:0,text:"{value}%",onChange:function(_1ec,_1ed){
}};
})(jQuery);
(function($){
function init(_1ee){
...
$.fn.menu.defaults={zIndex:110000,left:0,top:0,alignTo:null,align:"left",minWidth:120,itemHeight:32,duration:100,hideOnUnhover:true,inline:false,fit:false,noline:false,position:function(_43c,left,top){
return {left:left,top:top};
},onShow:function(){
},onHide:function(){
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:32,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:18,buttonText:"",buttonIcon:null,buttonAlign:"right",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
$(_76c)._outerWidth(_76d)._outerHeight(32);
}
}};
};
};
...
$(_785)._outerWidth(_786)._outerHeight(32);
}}});
