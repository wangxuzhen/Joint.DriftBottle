...
(function($){
    ...
    function initTrClick(that,_this){
		...
		$td.html('<div style="margin:0;padding:0;overflow:hidden;border:solid 0px red;height:'+(height)+'px;width:'+(width)+'px;">'
					+'<input type="text" id="dsfs" placeholder="'+placeholder+'" value="'+value+'" style="margin-left: 0px; margin-right: 0px; padding-top: 1px; padding-bottom: 1px; width:100%;height:100%">'
				+'</div>');
		$td.width(width);
